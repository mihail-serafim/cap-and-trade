...
if($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	$sql = "INSERT INTO `user_saves` (`id`, `node_graph`, `research_trees`, `currency`, `research`, `curr_emissions`, `emissions_cap`) VALUES ('$id', '$node_graph', '$research_trees','$currency', '$research', '$curr_emissions', '$emissions_cap');";
